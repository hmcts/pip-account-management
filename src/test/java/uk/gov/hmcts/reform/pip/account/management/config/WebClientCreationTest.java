...
class WebClientCreationTest {
    ...
    void withBearerTokenAddsAuthorizationHeaderWhenAuthorizedClientIsPresent() {
        ...
        ClientRequest returnedRequest = WebClientConfig.withBearerToken(request, authorizedClientManager);
    ...
    void withBearerTokenUsesDefaultClientRegistrationIdWhenAttributeNotSet() {
        ...
        WebClientConfig.withBearerToken(request, authorizedClientManager);
        ...
        assertEquals("publicationServicesApi", captor.getValue().getClientRegistrationId(),
