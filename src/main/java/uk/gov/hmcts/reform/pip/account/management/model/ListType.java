...
public enum ListType {
    ...
    SSCS_DAILY_LIST_ADDITIONAL_HEARINGS(UserProvenances.CFT_IDAM, ALL_VERIFIED_THIRD_PARTY_CFT_ROLES),
    ...
    ET_DAILY_LIST(UserProvenances.CFT_IDAM, ALL_VERIFIED_THIRD_PARTY_CFT_ROLES),
